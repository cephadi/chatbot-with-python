...
IFontDisp = Font
__all__ = [ 'FONTNAME', 'Gray', 'Picture', 'OLE_XPOS_HIMETRIC',
           'IPictureDisp', 'Unchecked', 'VgaColor',
           'OLE_XSIZE_PIXELS', 'OLE_CANCELBOOL', 'OLE_XPOS_CONTAINER',
           'Default', 'Monochrome', 'OLE_OPTEXCLUSIVE', 'FONTSIZE',
           'IFont', 'FONTUNDERSCORE', 'OLE_YPOS_PIXELS', 'Checked',
           'OLE_YSIZE_PIXELS', 'OLE_YPOS_CONTAINER', 'FONTBOLD',
           'IFontDisp', 'StdFont', 'OLE_XSIZE_CONTAINER', 'OLE_COLOR',
           'OLE_XSIZE_HIMETRIC', 'StdPicture', 'IFontEventsDisp',
           'OLE_HANDLE', 'OLE_TRISTATE', 'OLE_YSIZE_CONTAINER',
           'FONTSTRIKETHROUGH', 'OLE_XPOS_PIXELS',
           'LoadPictureConstants', 'OLE_YSIZE_HIMETRIC', 'IPicture',
           'FONTITALIC', 'OLE_YPOS_HIMETRIC', 'OLE_ENABLEDEFAULTBOOL',
           'Font', 'Color', 'FontEvents']
